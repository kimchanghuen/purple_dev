...
if(request.getParameter("etcData")!=null) 
{
    ...
    String idxData=request.getParameter("idxData"); //get country_id from index.jsp page with function country_change() through ajax and store in id variable
        
    System.out.println("파라미터 확인");
    System.out.println("etcData : " + etcData + " / idxData : " + idxData);    
    try
    {
        ...
        query.append("UPDATE DRV_DRIVERS SET d_etc='" + etcData + "'  WHERE  d_idx=" +  idxData);        
