...
// ------------------------------------------------------
 ...
 String t_code =  request.getParameter("t_code"); //get country_id from index.jsp page with function country_change() through ajax and store in id variable
 String t_name =  request.getParameter("t_name"); //get country_id from index.jsp page with function country_change() through ajax and store in id variable
 String t_enable =  request.getParameter("t_enable"); 
...
<div style="height:auto; text-align: center; " >
	 ...
	 <table style="margin:auto;">
	    <tr>
	    	...
	    	<td class="EditPageTable"><input type="text" id="code" value="<%=t_code %>" disabled></input></td>
	    </tr>
	    <tr>
	    	<td class="EditPageTable">코드명</td>
	    	<td class="EditPageTable">:</td>
	    	<td class="EditPageTable"><input type="text" id="name" value="<%=t_name %>"></input></td>
	    </tr>
	    <tr>
	    	<td class="EditPageTable"></td>
	    	<td class="EditPageTable"></td>
...
<br> 
<button type="button" onclick="type_change(); "> 수정하기 </button> 
